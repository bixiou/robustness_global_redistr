...
##### Non-US census frames: product of marginals #####
#
# Joint distribution = product of 1-D marginal proportions (independence assumption).
# pop_freq contains official statistics (Eurostat, Rosstat, etc.)
