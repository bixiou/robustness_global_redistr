...
rename_survey <- function(e, pilot = FALSE) {
  if (pilot) {
    names(e) <- c(
      ...
      "revenue_split_many_domestic_welfre",
      ...
      "solidarity_support_display_1",
      "solidarity_support_display_2",
      "solidarity_support_display_3",
      "solidarity_support_display_4",
      "solidarity_support_display_5",
      "global_tax_support",
      "hic_tax_support",
      "intl_tax_support",
      "maritime_split_ldc",
