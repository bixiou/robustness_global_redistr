...
# DIF(irt, which.items = 1:length(variables_interest_positive), which.par = c("a1", "d1"), free.baseline = FALSE, free.focal = TRUE)
...
with(e, summary(lm(custom_redistr_winners ~ variant_sliders, subset = custom_redistr_satisfied > 0)))
with(e, summary(lm(custom_redistr_losers ~ variant_sliders, subset = custom_redistr_satisfied > 0)))
with(e, summary(lm(custom_redistr_degree ~ variant_sliders, subset = custom_redistr_satisfied > 0)))
with(e, summary(lm(custom_redistr_losers ~ income_exact * country, subset = custom_redistr_satisfied > 0))) 
...
# Parameters matching average redistr:
algo_dis_av(728, 1000 - 728, 2.2, verbose = T) # matching 5.4% transfer (min income: 344$)
algo_dis_av(728, 1000 - 728, 1.58, verbose = T) # matching 247$ min income (transfer: 4%)
