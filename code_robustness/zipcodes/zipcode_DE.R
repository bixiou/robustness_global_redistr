...
data2 <- read.xlsx("/../../data_ext/source_zipcode/AuszugGV4QAktuell.xlsx", sheet = 2, startRow = 6, colNames = TRUE)
...
data_add <- read.csv(""../../data_ext/source_zipcode/zipcode_DE.csv"")
...
write.csv(result_extended, "zipcode_DE_complete.csv", row.names = FALSE)
