...
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$gcs_belief, na.rm = T), 3))
...
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$reparations_support[!d(c)$reparations_support %in% 0] > 0, na.rm = T), 3))

sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_satisfied, na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_skip, na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_winners[d(c)$custom_redistr_satisfied], na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_losers[d(c)$custom_redistr_satisfied], na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_degree[d(c)$custom_redistr_satisfied], na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_winners[!d(c)$custom_redistr_winners %in% c(401, 601)], na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_losers[!d(c)$custom_redistr_losers %in% c(101, 201)], na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_degree[!d(c)$custom_redistr_degree %in% c(2.1, 7.1)], na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_winners %in% c(401, 601), na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_losers %in% c(101, 201), na.rm = T), 3))
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$custom_redistr_degree %in% c(2.1, 7.1), na.rm = T), 3))
...
sapply(paste0(pilot_countries, "p"), function(c) round(mean(d(c)$survey_biased > 0, na.rm = T), 3))