...
\begin{subfigure}{.48\textwidth}
  \caption[]{\blue{Cut development aid}: $-$4 pp*** }\vspace{-.3cm}
  \includegraphics[width=\textwidth]{../figures/country_comparison/program_preferred_by_cut_aid_in_program.pdf}
\end{subfigure} \pause
\begin{subfigure}{.50\textwidth}
  \caption[]{\blue{International tax on millionaires with 30\% financing} health and education in \blue{low-income countries}: +4 pp*** %\quad \green{\checkmark H1b}
  } \vspace{-.3cm}
