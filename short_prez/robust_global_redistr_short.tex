...
% \begin{center}
% \begin{LARGE}
% \textcolor{magenta}{CRIS Seminar} \end{LARGE}
% \vspace{1cm}
...
% \bbvsp
% % \ip International Preferences for Income Distribution: Evidence from ISSP, 1987-2009, \textit{Master thesis}, Fabre, 2016.
% \ip French attitudes on climate change, carbon taxation and other climate policies, \\ \textit{Ecological Economics}, Douenne \& Fabre, 2020.
% \ip French Favored Redistributions Derived from Surveys, \textit{Revue économique}, Fabre, 2022.
% \ip \blue{Yellow Vests, Pessimistic Beliefs, and Carbon Tax Aversion}, \\ \textit{American Economic Journal: Economic Policy}, Douenne \& Fabre, 2022.
% \ip \blue{Fighting Climate Change: International Attitudes toward Climate Policies}, \\ \textit{American Economic Review}, A. Dechezleprêtre et al., 2025.
% \ip \blue{Majority Support for Global Redistributive and Climate Policies}, \\ \textit{Nature Human Behaviour}, Fabre et al., 2025.
% \ip \textit{Un Plan mondial pour le climat et contre l'extrême pauvreté}, \\ Eds. Bord de l'Eau, 2024. (preface by \textit{Gabriel Zucman}).
% \ip An International Plan for Sustainable Development, \textit{Ecological Economics}, Fabre et al., forthcoming.
% \ip Shortfall of Domestic Resources to Eradicate Extreme Poverty by 2030, \\ \textit{The Journal of Development Studies}, Fabre, 2025.
% \ip Cautiousness When Experts Disagree, \textit{Journal of Economic Theory}, Bommier et al., forthcoming.
% \ee
% \end{frame}

% \begin{frame}{Research Agenda}
% \bbvsp
% \ip ANR JCJC \rose{\textit{Cap \& Share}} until 12/2028:
% \bbvsp 
%   \ip Strength of Support for Global Climate Justice in Western Countries
%   \ip Beyond Current Initiatives: ITMO Regulations to Ratchet up Ambition
%   \ip Designing an Internationally Uniform Carbon Price
%   \ip Cartels and Oil Prices in the Event of a Climate Coalition
%   \ee
% \ip \rose{Qualitative surveys} in FR, IT, UK, US:
% \bbvsp 
%   \ip What do people say about politics?
%   \ip Why do people worry about money?
%   \ip What do people think about global redistribution?
%   \ee
% \ip World Region Predicts Well-Being Better Than National Income
% \ip \rose{How Much Should I Donate?}
% \ip \blue{Attitudes} towards inheritance taxation, government budget, immigration
% \ip Elite attitudes towards redistribution and global justice policies
% \ee
% \end{frame}


% \begin{frame}{Why CRIS?}
% \bbvsp
% \ip Engage more deeply with \blue{sociology}
% \ip Discovering new perspectives, building \rose{new connections}
% \ip Multidisciplinary environment closely tied to \blue{public policy}
% \ip \rose{Teach} at Sciences Po
% \ee
% \end{frame}
...
\begin{center}
\begin{LARGE}
\textcolor{magenta}{Public Acceptance of International Redistribution}\\~\textcolor{blue}{in High-Income Countries} \end{LARGE}
\vspace{1cm}
...
\bbvsp \ip \rose{Consensus for a global tax on millionaires; median preferred allocation of revenue: 30\%  to LICs}.
...
\begin{frame}{Data\label{data}}
  \vspace{.1cm}
\makebox[\textwidth][c]{ \includegraphics[width=\textwidth]{../figures/maps_participation/country_coverage_curtailed.png}} \vspace{-.5cm}
\bbvs
\ip \blue{12,000 respondents} (Europe: 5,000; USA: 3,000; Japan: 2,000; Saudi Arabia, Russia: 1,000).
\ip Data collected from April 15 to July 3, 2025; except in Russia: Sep 19 to Oct 9.
\ip \blue{Representative} along: gender, age, income, education, urbanicity, region. \hyperlink{representativeness}{\beamergotobutton{Representativeness tables}} 
\ip \blue{Results on control group}, weighted using quota variables and aggregated with country population.
...
\begin{subfigure}{.48\textwidth}
  \caption[]{\blue{Cut development aid}: $-$3 pp*** }\vspace{-.3cm}
  \includegraphics[width=\textwidth]{../figures/country_comparison/program_preferred_by_cut_aid_in_program.pdf}
\end{subfigure} \pause
\begin{subfigure}{.50\textwidth}
  \caption[]{\blue{International tax on millionaires with 30\% financing} health and education in \blue{low-income countries}: +5 pp*** %\quad \green{\checkmark H1b}
  } \vspace{-.3cm}
...
\centering Share of (somewhat or strong) \textit{support} among non-\textit{indifferent} answers. \quad  \hyperlink{solidarity_support_absolute}{\beamergotobutton{Absolute support}} \\
...
\begin{frame}{No evidence of warm glow\label{warm_glow}} 
  ...
  \vspace{-.3cm}
    \begin{figure}
\caption{If \textit{warm glow}, support might dissipate when the policy materializes}\vspace{-.6cm}
\begin{subfigure}{.5\textwidth} 
  % \caption[]{\normalsize If \textit{warm glow}, support might dissipate when the policy materializes}
...
\begin{subfigure}{.47\textwidth} 
  \caption[]{Effect of \blue{information about ongoing global redistribution} initiatives on the share of plausible \rose{global policies} supported: +1p.p.* \quad \hyperlink{2SLS}{\beamergotobutton{2SLS}}}
...
\only<+>{\centering \blue{\textbf{High}} coverage (64-72\% of world emissions), \rose{\textbf{color}} variant, as shown in the U.S.
...
\begin{frame}{International Climate Scheme}
\makebox[\textwidth][c]{ \includegraphics[width=.89\textwidth]{../figures/country_comparison/variables_ncs_gcs_ics_control_by_country}} % ncs_gcs_ics_all_mean
\vspace{-.7cm}
\bbvsp
...
\makebox[\textwidth][c]{ \includegraphics[width=.89\textwidth]{../figures/country_comparison/variables_wealth_tax_support_by_country}} % wealth_tax_support_positive
...
\section{Sociodemographic determinants}
\begin{frame}{Synthetic indicators}
\begin{figure}[h!]
    \caption[Average synthetic indicators of support for global redistribution]{Average synthetic indicators of support for global redistribution. 
...
\begin{frame}{Synthetic indicators}
\begin{figure}[H]
    \caption[{[}On selected vote or nationality{]} Average synthetic indicators of support]{{[}On selected vote or nationality{]} Average synthetic indicators of support for global redistribution.
...
\begin{frame}{Synthetic indicators}
\begin{figure}[H]
    \caption[{[}On selected demographics{]} Average synthetic indicators of support]{{[}On selected demographics{]} Average synthetic indicators of support for global redistribution. 
...
\begin{frame}{Variance decomposition}
  \begin{figure}
    \centering
    % Top row of subfigures
    \begin{subfigure}{.48\textwidth}
      \centering
      \includegraphics[width=\linewidth]{../figures/all/lmg_gcs_support_few.pdf}
      \caption{Support for the Global Climate Scheme\\ (10\% of variance explained).\label{fig:lmg_gcs}}
    \end{subfigure}
    \hfill
    \begin{subfigure}{.48\textwidth}
      \centering
      \includegraphics[width=\linewidth]{../figures/all/lmg_share_solidarity_supported_few.pdf}
      \caption{Share of plausible global policies supported\\ (15\% of variance explained).\label{fig:lmg_solidarity}}
    \end{subfigure}
  \end{figure}
\end{frame}
...
\begin{frame}{Custom redistribution \href{run:survey_custom_redistr.mp4}{\beamergotobutton{Video}} \href{https://bit.ly/custom_redistr}{\beamergotobutton{bit.ly/custom\_redistr}}} 
    ...
    \only<+>{\begin{figure}\caption{Average custom redistribution} 
...
\ip Strong majority acceptance of globally redistributive policies.
\ip Support reduces (only) slightly when fewer countries participate.
\ip Acceptance is genuine. No evidence of warm glow.
...
\ip \begin{center} \textbf{Thank you for your attention!} \\   Working paper at \blue{\href{https://bit.ly/support_global_redistr}{bit.ly/support\_global\_redistr}} \end{center}
\ee
\end{frame}
...
\begin{frame}{Determinants of support for global redistribution (selected variables)\label{determinants}  \hyperlink{gcs}{\beamergotobutton{Go back}}}  
  % Variables such as country and country:region are in the regressors but display is omitted.
    ...
    \begin{table}[h]
        \makebox[\textwidth][c]{
            \resizebox*{!}{.97\textheight}{
            \input{../tables/determinants_omit_many.tex}
            }
        }
    \end{table} 
\end{frame}
