...
\end{enumerate} 
 ...
 [\textit{Four random branches}; \textit{Section \ref{subsec:considerations}; Figures \ref{fig:wordcloud}, \ref{fig:field_keyword}-\ref{fig:injustice_field}}; \textit{Random answers can be found on \href{http://preferences-pol.fr/fields2025.html}{bit.ly/fields2025}}; 
...
\item  \label{q:comment_field} The survey is nearing completion. You can now enter any comments, thoughts, or suggestions in the field below. [\textit{Figure \ref{fig:comment_field}}; \textit{Random answers can be found on \href{http://preferences-pol.fr/fields2025.html}{bit.ly/fields2025}}; 
