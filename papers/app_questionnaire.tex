...
\verb|millionaire|]
  \\ \textit{Very unlikely; Unlikely; Likely; Very likely; I am already a millionaire}\footnote{We defined millionaire as having a net wealth of one million dollar or its rounded conversion to Local Currency Unit, except in Poland and Saudi Arabia, where there was a translation mistake (making ``millionaire'' corresponding to a net wealth of \$250,000 in these countries).}
...
\verb|comment_field|] \hfill (Back~to~Section~\ref{par:flow}.)
