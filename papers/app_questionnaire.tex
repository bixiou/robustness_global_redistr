...
~[\textit{Figures \ref{fig:split_few_bars_nb0}-\ref{fig:split_few}}; 
...
100\%.}\\\\ 
~[\textit{Figures \ref{fig:split_many}-\ref{fig:split_many_global_mean}}; 
...
%   \\ \textit{Scenario A; Scenario B}
  ~[new page] [\textit{Two random branches: top1; top3}; \textit{Figures \ref{fig:top_tax_share}-\ref{fig:top_tax_positive}}; 
...
~[\textit{Figures \ref{fig:transfer_how_positive}-\ref{fig:transfer_how_negative}}; 
\verb|transfer_how|]
~[Item order is randomly flipped or not]
\begin{itemize}
...
% \verb|custom_redistr|]
~[\textit{Figures \ref{fig:custom_redistr_mean}-\ref{fig:custom_redistr_median}} 
...
\end{enumerate} 
 ...
 \begin{enumerate}[resume] 
\item  \label{q:my_tax_global_nation} To what extent do you agree or disagree with the following statement? "My taxes should go towards solving global problems." [\textit{Figures \ref{fig:my_tax_global_nation_share}-\ref{fig:my_tax_global_nation_positive}}; 
