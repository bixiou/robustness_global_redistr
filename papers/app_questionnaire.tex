...
\item  \label{q:group_defended} Which group of people do you advocate for when you vote? [\textit{Section \ref{par:group_defended}; Figures \ref{fig:group_defended}, \ref{fig:group_defended_all}}; 
\verb|group_defended|] % TODO! RU, SA versions
