...
% \\ I received funding from the Agence Nationale de la Recherche for this research (ANR-24-CE03-7110). The project has been approved by the CIRED institutional review board (IRB-CIRED-2025-2) and preregistered in the Open Science Foundation registry (\href{https://osf.io/7mzn4}{osf.io/7mzn4}). % TODO!! AER registry
...
For example, most people reason from their own perspective (e.g. ``my pension is too low'', ``I want to buy a house'') and do not refer to the broader picture or to political reforms. In Appendix~\ref{subsec:slant}, I report a list of topics 
% that I find overrepresented in each country
my impressions of each country's slant. 
To get a sense of people's own words, a random selection of responses is displayed at \href{http://preferences-pol.fr/fields2025.html}{bit.ly/fields2025}. %  also https://www.centre-cired.fr/random_fields/
...
} % TODO!! check footnote \footnote{Compared to the average absolute effect size (weighted by countries' population sizes), our effects of interest are 31\% lower on (weighted) average, but the difference is not statistically significant.} %
...
I received funding from the Agence Nationale de la Recherche for this research (ANR-24-CE03-7110). This RCT was registered as \href{https://www.socialscienceregistry.org/trials/17248}{AEARCTR-0017248}. I am grateful to Alina Timoshkina and Gerhard Toews for helping me launch the survey in Russia. I thank researchers who kindly gave me access to their data: Félix Bajard for wealth distribution and Amory Gethin for income distribution. %, Gerhard Toews for Russian census. 
