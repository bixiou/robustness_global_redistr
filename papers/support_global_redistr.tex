...
% Following the works of \cite{enke_moral_2020,cappelen_universalism_2025}, it is interesting to measure the degree of universalism. % TODO! elaborate, read. : good predictor of vote enke_moral_2020 and ideology enke_moral_2023
...
\cite{beiser-mcgrath_could_2019} demonstrate that a climate agreements with broader country coverage are %15 p.p. 
...
is accepted by 68\% of respondents (ranging from 56\% in Poland to 88\% in Saudi Arabia).\footnote{The acceptance of the NCS is higher than the support for a \textit{tax}-and-dividend policy found in other surveys \citep{douenne_yellow_2022,mildenberger_limited_2022,fabre_majority_2025}. Indeed, most people prefer emissions trading schemes to carbon taxes \citep{funke_prices_2025}, and support drops (before recovering) in specific contexts, such as the Yellow Vests movement.} 
