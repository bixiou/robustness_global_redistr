...
Consistent with the cross-national differences observed in other measures, the share of universalists is lowest in Japan. % and the U.S. %, and highest in Saudi Arabia. % TODO keep the next sentence but cut this one and add at the end of the paragraph the country raning from latent
...
The interactive question is available at \href{https://www.centre-cired.fr/custom-global-redistr}{bit.ly/custom\_redistrib} and the algorithm translating slider positions into a redistribution is described in Appendix \ref{app:algo}. %and a video explainer on TODO. https://youtu.be/gSfsQwczT7w
