...
% TODO? q-values (multiple hypotheses testing); support in Dem/swing states; IV on non-committment; multi-level modeling (explaining country-level support); Gini before/after income redistr; 
...
\begin{center}
{\textbf{\href{https://github.com/bixiou/robustness_global_redistr/raw/main/papers/support_global_redistr.pdf}{Link to most recent version}}} % AER
\end{center}
...
% TODO! poverty gaps in median/average preferred redistribution
