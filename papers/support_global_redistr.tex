...
In this Section, I uncover the acceptance of globally redistributive policies depending on the coalition of countries that would implement them. I study in turn a climate policy and a wealth tax.


\subsection{International Climate Scheme}
...
% majority support NCS (cite Douenne & Fabre? Bergquist?)
% GCS: a bit less supported than NCS (fn comparison FDM: attitude change, higher price, % instead of absolute)
