% free: xAPSR; xBJPS (10k, guidelines); xAJPS; JoP; Comparative Political Studies; xJEEA membership ($100) + $100; AEJ:EP $300 (+$400 if publi); JIE $190; JPubE $165; Perspectives on Politics; xWorld Development $0 (10k, guidelines)
% Order: xEJ (no word limit, 100£), xJEEA (200$), AEJ:EP (no word limit, 700$), xAJPS (10k free, everything incl. reference except abstract), xBJPS (10k free, main body + figures + footnotes), xWD (free, 10k main body), JoP (35p double space, free), Political Behavior (9k w), Journal of Public Opinion Research
...
% TODO cite Drupp et al 25: Global Justice Report revision
...
% potential reviewers: Stostad (morten.stostad@nhh.no), ghassim (farsan.ghassim@ucd.ie), Dario Krpan (d.krpan@lse.ac.uk), Gianluca Grimalda (g.grimalda@gmail.com), Thomas Sterner (thomas.sterner@economics.gu.se)
...
\begin{abstract}
  ...
  % 149 words
Using an original survey of 12,000 respondents representative of eleven high-income countries (the United States, Japan, Russia, Saudi Arabia, and seven European countries), I examine public support for international redistribution and climate policies. 
...
Despite stated acceptance, international redistribution lacks prominence in policymaking and public debates. %An information treatment shows that support for global policies causally increases among respondents who perceive them as likely; an effect opposite to warm glow. 
I solve this prominence--preference puzzle using survey experiments. An information treatment shows that support for global policies causally increases among respondents who perceive them as likely, an effect opposite to ``warm glow''. Rather than insincere or inconsistent attitudes, I show that low salience and pluralistic ignorance can reconcile strong acceptance with low prominence.
I also test the sensitivity of acceptance to key policy features such as the size of transfers and country coverage. %Although global inequality is not a salient concern, it is perceived as a significant injustice. There is majority acceptance in every country for nearly all global policies tested, including those that would redistribute 5 percent of global income or entail personal costs for respondents. An information treatment shows that support for global policies causally increases among respondents who perceive them as likely; an effect opposite to warm glow. 
Support for international policies decreases only slightly as country coverage shrinks. 
% Overall, the results % reinforce previous findings and % AER
% suggest that a broad coalition of countries could feasibly advance sustainable development. 
% Using an original survey of 12,000 respondents representative of eleven high-income countries (the United States, Japan, Russia, Saudi Arabia, and seven European countries), I examine public support for international redistribution and climate policies, as well as its sensitivity to key policy features such as the size of transfers and country coverage. Although global inequality is not a salient concern, it is perceived as a significant injustice. There is majority acceptance in every country for nearly all global policies tested, including those that would redistribute 5 percent of global income or entail personal costs for respondents. An information treatment shows that support for global policies causally increases among respondents who perceive them as likely; an effect opposite to warm glow. Support for international policies decreases only slightly as country coverage shrinks. Overall, the results 
...
This preference--prominence puzzle could be explained by an overstatement of support in previous surveys or by a discrepancy between public attitudes and official policy. % TODO!! explain somewhere that victories of far right (here in footnote?) is not revealed preference against global redistribution since (i) far right voters remain a minority (vs. left/center voters and non-voters), (ii) far right voters' nationalism is more on immigration than not caring about basic needs in LICs (anecdotal evidence that they may be in favor since reduces immigration), (iii) don't vote on the topic of global redistribution but on immigration, societal issues, against nanny state (in own country),  cf. fields, (iv) majority of even Trump voters for wealth tax funding LICs; replace main_radical_redistr_pol_positive by _share, explaining (or updating) that "More likely" is "More likely than not" in a note; majority support even among Trump voters (50.3%) to tax millionaires with 30% funding LICs
In this paper, I solve the puzzle by demonstrating how low salience and pluralistic ignorance can reconcile strong acceptance with low prominence. 
...
This indicates that most people prioritize sustainable development abroad less than the average issue, but still consider it worthwhile. % TODO!! reword last sentence? e.g. second-most prioritized item in Europe, last in U.S. and Japan, most consider it worthwhile. Say that if we let randomly drawn citizens allocate revenue from intl tax it would probably be favorable to LICs?
...
The project has been approved by the CIRED institutional review board (IRB-CIRED-2025-2) and %is approved by IRB at Harvard University (IRB21-0137), and APSR/AER
...
\begin{figure}[h!]
  \caption[Word cloud of open-ended field, per variant]{Most common concepts in open-ended fields. (Questions~\ref{q:concerns_field}-\ref{q:issue_field})} \label{fig:wordcloud} % Random answers can be found on \href{http://preferences-pol.fr/fields2025.html}{bit.ly/fields2025}
...
To get a sense of respondents' own words, random selections of responses are displayed at \href{http://preferences-pol.fr/fields2025.html}{bit.ly/fields2025}. %  also https://www.centre-cired.fr/random_fields/
...
The interactive question is available at \href{http://preferences-pol.fr/custom_global_redistr.html}{bit.ly/custom\_global\_redistr}, an explainer video at \href{https://youtu.be/gSfsQwczT7w}{youtu.be/gSfsQwczT7w}, and the algorithm translating slider positions into a redistribution is described in Appendix \ref{app:algo}. 
...
Alternatively, it could be due to a lack of demand from constituents. Indeed, global inequality is rarely a top-of-mind consideration. People's most frequent concerns relate to self-interested issues such as their purchasing power or health; articulated political demands generally refer to national issues such as public services; and the most salient international issues are climate change, wars, and the rise of the far right. % TODO!! also lack of international integration of political movements
...
% TODO!! change "organization of the world order based on nation-states" since it seems like I oppose it? how to counter the argument that people want nation-states? cite Ghassim? talk about corruption in LICs? explain that governments are reluctant to tax the rich unilaterally for fears of relocation and losing competitiveness, and new taxes would be needed to fund LICs? talk about corruption in LICs?
...
\begin{bibunit}[plainnaturl_clean] % !AER
% \begin{bibunit}[chicago] % APSR

\clearpage % AER
% \begin{small}
\section*{\normalsize Acknowledgements} % APSR
I received funding from the Agence Nationale de la Recherche for this research (ANR-24-CE03-7110). %The randomized controlled trials were registered in the American Economic Association's registry for randomized controlled trials under ID \href{https://www.socialscienceregistry.org/trials/17248}{AEARCTR-0017248}. %This RCT was registered as \href{https://www.socialscienceregistry.org/trials/17248}{AEARCTR-0017248}. 
The project has been approved by the CIRED institutional review board (IRB-CIRED-2025-2) and %is approved by IRB at Harvard University (IRB21-0137), and 
preregistered in the Open Science Foundation registry (\href{https://osf.io/7mzn4}{osf.io/7mzn4}). 
I am grateful to Alina Timoshkina and Gerhard Toews for helping me launch the survey in Russia. I thank researchers who kindly gave me access to their data: Félix Bajard for wealth distribution and Amory Gethin for income distribution. %, Gerhard Toews for Russian census. 
