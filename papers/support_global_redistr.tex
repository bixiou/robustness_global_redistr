...
% TODO! Supports => Accepts in Figures
\section{Conclusion} % Summary, conclusion

Applying the theory of optimal taxation, \cite{kopczuk_limitations_2005} shows that the level of U.S. foreign aid could only be rationalized if the U.S. assigned a value 2,000 times higher on the welfare of a US-American compared to that of a foreigner (though this multiple should be reduced by the proportion wasted or diverted in foreign aid transfers). 
...
Indeed, a majority of respondents in HICs support a global tax on top incomes to finance poverty reduction in LICs. I also find that over two-thirds accept a tax on the wealth of millionaires with 30\% of revenue financing LICs, even if only a few countries would implement it. In every country, majorities accept an International Climate Scheme costly to them but beneficial to the poorest humans, showing that most people value climate action and poverty reduction. 

The revenue allocation task sheds light on how much people value global versus domestic public goods, with an average of 17.5\% of the revenue from a hypothetical global wealth tax allocated to sustainable development, among the five items. 
This indicates that people are neither selfless universalists, as this would command to channel all revenue from this tax to the poorest countries, nor devoid of altruism to foreigners, as this would imply to allocate nothing to global spending. 
The custom redistribution task confirms that most people would actually prefer much more global redistribution than currently exists, as the average respondent chooses a global minimum income of \$247 per month, financed by transfers over 5\% of world income. 

Exploring respondents' underlying values, the support for global redistribution seems to stem primarily from a sense of duty and empathy towards the destitute. For some people, this issue appears important enough to be factored in in their voting choice. Indeed, the likehood that a political program is preferred increases if it contains a globally redistributive tax on millionaires and decreases with cuts to foreign aid. Furthermore, a third of respondents report that they would be more likely to vote for a political party if it were part of a global movement for sustainable development, and a similar proportion state they could participate in such a movement. 

These results beg the question as to why so few policymakers campaign on sustainable development proposals. This lack of supply of such campaigns might come from pluralistic ignorance of policymakers and activists, consistent with the underestimation of support for a Global Climate Scheme by the public. % as well as with previous studies \citep{}
Or it can be explained by a lack of demand from constituents. Indeed, global inequality is rarely a top-of-mind consideration. The most frequent concerns of people relate to self-interested issues such as their purchasing power or health, articulated political demands generally refer to national issues such as public services, and the most salient international issues are climate change, wars, and the rise of the far right. 

The low salience of global inequality may translate into a lack of popular mobilization and, in turn, a low priority for policymakers. Combined with the necessary trade-off that global redistribution entails with boosting fellow citizens' purchasing power, policymakers may prioritize the latter, which is the primary concern of voters, to the point of ignoring universalist attitudes. 
A compounding factor is the status quo bias: the weakness of global institutions and the primacy of national polities make international cooperation unlikely, % the lack of a worldwide polity 
which may discourage universalist thought as utopian. % mute the expression of universalist mindsets 
...
Indeed, support for global policies is partly caused with the belief that they are likely, as our information experiment demonstrated. Therefore, the organization of the % solidarity confined at the national level 
world order in nation-states might mute demands for % ``utopian''
universalist reforms and contribute to a vicious circle where the low salience of universalist concerns and status quo institutions reinforce each other. 

Nevertheless, the survey results %widespread acceptance of sustainable development proposals 
suggest some untapped potential for global solidarity. It is unlikely that global redistribution policies would be resisted by the public. This is espcially true for balance sheets operations which have expansionary impacts and indirect costs, such as debt restructuring, liquidity provision, %currency swaps, 
the expansion of lending by Multilateral Development Banks, and their recapitalization through the rechanneling of Special Drawing Rights. These reforms are largely accepted and are the natural focus of multilateral initiatives \citep{bridgetown_initiative_bridgetown_2025,ffd4_outcome_2025}. % Fair allocation of taxing rights, address illicit flows...
