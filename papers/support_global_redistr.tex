...
% TODO! ajouter p-value; Table S1 -> bla (Table S1); Appendix -> footnotes
...
Indeed, the AI incorrectly classifies unspecific answers like ``poverty'' in this category,\footnote{Interestingly, out of the 47  (one-word) answers ``poverty'', the zero-shot prompt passed to ChatGPT-4.1 only coded 42 of them as \textit{global inequality}, illustrating the lack of consistency of this classifier.} while the keyword search misses answers like ``inequality among humans''. 
