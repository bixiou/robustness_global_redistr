...
% TODO? q-values (multiple hypotheses testing); support in Dem/swing states; IV on non-committment; multi-level modeling (explaining country-level support)
...
% Alternative explanation for status quo bias: bandwagon effect (updating on social norms), noise, credibility effect (belief updating on policy features).
