...
\begin{figure}
  ...
  \begin{subfigure}{.68\textwidth}
    \caption[]{}
    \includegraphics[width=\textwidth]{../figures/country_comparison/split_main_means_nolegend.pdf}
  \end{subfigure} 
  \begin{subfigure}{.30\textwidth}
    \caption[]{} 
    \includegraphics[width=\textwidth]{../figures/country_comparison/split_main_nb0_nolabel.pdf}
  \end{subfigure}
\end{figure}
...
\begin{subfigure}{.48\textwidth}
  \caption[]{\blue{Cut development aid}: $-$5 pp*** \quad \green{\checkmark H1a}}
...
\end{subfigure}
\end{figure}
% # 7bis: 2SLS \input{../tables/iv_highlighted.tex}
...
\begin{figure}[h!]
    \caption[Relative support for plausible global redistribution policies]{Relative support for plausible global redistribution policies (Percentage of \textit{Somewhat} or \textit{Strongly support} among non-\textit{Indifferent} resposnes). (Question \ref{q:solidarity_support}).
