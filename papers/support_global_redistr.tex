...
% is top3_tax 5.1% of world income or HIC income? => World, but overestimated (in reality it's 4.3%) due to "rounding" errors when interpolating from countries distrib to world distrib using too coarse an interpolation => give true figures both in PPP (4.3%) and nominal () terms. TODO!! compute nominal; TODO! compute custom_redistr avec 1e4
