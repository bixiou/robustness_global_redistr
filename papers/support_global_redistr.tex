...
Indeed, the AI incorrectly classifies unspecific answers like ``poverty'' in this category,\footnote{Interestingly, out of the 45 (one-word) answers ``poverty'', ChatGPT-4.1 only coded 42 of them as \textit{global inequality}, illustrating the lack of consistency of this classifier.} while the keyword search misses answers like ``inequality among humans''. 
...
\section{Acceptance of International Policies Depending on Country Coverage\label{sec:coverage}}
