...
\begin{center}
{\textbf{\href{https://github.com/bixiou/robustness_global_redistr/raw/main/papers/aer.pdf}{Link to clickable % most recent clickable
version}}} % AER
\end{center}
...
% revision: American -> American TODO: AER
...
\begin{table}[!htbp] 
  ...
  \makebox[\textwidth][c]{\input{../tables/IV_warm_glow_no_star.tex}} % AER _no_star
  \textit{Note: Robust standard errors (HC1) are reported in parentheses. \hfill \\ % $^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01. \\ % AER
...
% Taken at face value, these results would mean that a successful global solidarity movement could collect up to \$10~billion and organize some of the largest demonstrations in history, matching Earth Day mobilizations.\footnote{On April 22, 1970, 20 million Americans (10\% of the population) demonstrated for the environment. Since then, Earth Day events regularly mobilize hundreds of millions of people worldwide.} % TODO cut for AER
