...
% TODO revision cite Smith et al. 25, Gregersen et al. 25
...
In fact, some effects are no longer significant in the specification without controls, with $p$-values for the IV and the direct effect at .11 and .12, respectively (Table~\ref{tab:iv_wo_control}). % AER
} 
...
% for its advocates. % TODO add for AER
...
As explained in Section \ref{sec:data}% and shown in Appendix \ref{app:comparison}% TODO AER revision
...
% TODO! aer revision cite Carson et al 24, Hoy et al 25 on attitudes in MICs (they prefer public services)
