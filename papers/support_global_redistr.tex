...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/maps_participation/country_coverage_progress.png}} 
\end{figure}
% # 2. survey_flow
\begin{figure}[h!]
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/country_comparison/variables_ncs_gcs_ics_by_country.pdf}} 
\end{figure}
