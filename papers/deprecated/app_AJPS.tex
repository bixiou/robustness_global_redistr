...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/country_comparison/field_manual_pol_US_positive.pdf}} 
% \end{figure}
% \hfill (Back~to~Section~\ref{par:representativeness}.)
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/country_comparison/main_radical_redistr_dem_positive.pdf}} 
% \end{figure}
% \hfill (Back~to~Section~\ref{par:representativeness}.)
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/country_comparison/solidarity_support_dem_share.pdf}} 
% \end{figure}
...
\begin{figure}[H]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/country_comparison/synthetic_indicators_dem_mean.pdf}} 
\end{figure}
% \hfill (Back~to~Section~\ref{par:representativeness}.)
...
%     \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/country_comparison/field_manual_dem_positive.pdf}} 
% \end{figure}
% \hfill (Back~to~Section~\ref{par:representativeness}.)
...
\end{enumerate} 
 ...
 [\textit{Four random branches}; \textit{Section \ref{subsec:considerations}; Figures \ref{fig:wordcloud}, \ref{fig:field_manual}-\ref{fig:injustice_field}}; \textit{Random answers can be found on [anonymized for review]}; 
...
~\\~[\textit{Section \ref{subsec:conjoint}; Figures \ref{fig:conjoint}, \ref{fig:conjoint_US}};% \ref{fig:conjoint_vote}-\ref{fig:conjoint_ES_original}}; 
\verb|conjoint|]
...
100\%.}\\\\ 
~[\textit{Section \ref{subsec:revenue_split}; Figures \ref{fig:split}, %\ref{fig:split_many}-
\ref{fig:split_many_global_mean}}; 
...
~[\textit{Section \ref{subsec:transfer_how}; Figure \ref{fig:transfer_how}%, \ref{fig:transfer_how_above_one}-\ref{fig:transfer_how_negative}
}; 
\verb|transfer_how|]
~[Item order is randomly flipped or not]
\begin{itemize}
...
% \verb|custom_redistr|]
~[\textit{Section \ref{subsec:custom_redistr}; Figure \ref{fig:custom_redistr_question}}%, \ref{fig:custom_redistr_mean}-\ref{fig:custom_redistr_transfer_ceiling}} 
...
\textit{Random answers can be found on [anonymized for review]}; %\href{http://preferences-pol.fr/fields2025.html}{bit.ly/fields2025}}; 
