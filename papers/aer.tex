...
\defaultbibliographystyle{aea} % plainnaturl_clean AER
...
% TODO! attrition by branch and branches sizes (in AEA RCT Registry)
...
I received funding from the Agence Nationale de la Recherche for this research (ANR-24-CE03-7110). The project has been approved by the CIRED institutional review board (IRB-CIRED-2025-2) and preregistered in the Open Science Foundation registry (\href{https://osf.io/7mzn4}{osf.io/7mzn4}). I am grateful to Alina Timoshkina and Gerhard Toews for helping me launch the survey in Russia. I thank researchers who kindly gave me access to their data: Félix Bajard for wealth distribution and Amory Gethin for income distribution. %, Gerhard Toews for Russian census. 
...
% In fact, some effects are no longer significant in the specification without controls, with $p$-values for the IV and the direct effect at .11 and .12, respectively (Table~\ref{tab:iv_wo_control}).
} 
...
\begin{bibunit}[aea] % plainnaturl_clean AER
