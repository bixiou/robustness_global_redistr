...
\subsection{Figures}
% Country-specific raw results are also available as supplementary material files:  \href[anonymized repository], \href[anonymized repository], \href[anonymized repository], \href[anonymized repository], \href[anonymized repository], \href[anonymized repository].
