...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/country_comparison/sustainable_future.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=\textwidth]{../figures/country_comparison/convergence_support.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.6\textwidth]{../figures/country_comparison/survey_biased.pdf}} 
\end{figure}
