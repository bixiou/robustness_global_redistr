...
\clearpage
\section{Survey features}\label{app:features}

\subsection{Country-specific features}\label{subsec:country_features}

\begin{table}[!h]\label{tab:features}
\caption[Country-specific features]{\hypertarget{tab_features}{Country-specific features of the questionnaire}.}
