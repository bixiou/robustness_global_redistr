...
Unless otherwise specified, responses are compulsory and a single response much be chosen.
...
\begin{figure}[h!]
    \caption[{[}On selected demographics{]} Average synthetic indicators of support]{{[}On selected demographics{]} Average synthetic indicators of support for global redistribution. (Question~\ref{q:solidarity_support}).
