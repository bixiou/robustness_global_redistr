...
\paragraph{Plausible global policies.} Table \ref{tab:plausible_policies} provides references that show that the ``plausible global policies'' I test (Section~\ref{subsec:debated}) are (similar to proposals) debated in international negotiations.
...
In the questionnaire, various questions are tailored to country-specific characteristics. Table \ref{tab:features} reports the figures used for each country. 
