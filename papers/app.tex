...
% I use this data directly for the custom redistribution (where I convert it back to LCU) and indirectly for the tax on top income. In the latter case, I calibrate the tax schedules so that they 
