...
\begin{table}[!htbp] 
  ...
  \textit{Note: Robust standard errors (HC1) are reported in parentheses. \hfill $^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01. \\ Control variables (omitted in the table) are: vote, gender, age, income, education, urbanity, likelihood of becoming millionaire, living with partner, employment status, foreign born, country region.}
\end{table}
...
\begin{table}[!htbp] 
  ...
  \makebox[\textwidth][c]{\input{../tables/IV_warm_glow_wo_control.tex}}
  \textit{Note: Robust standard errors (HC1) are reported in parentheses. \hfill $^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01. }
\end{table}
