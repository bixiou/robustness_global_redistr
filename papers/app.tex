...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/country_comparison/ncqg.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/country_comparison/ncqg_full.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/country_comparison/sustainable_future.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/country_comparison/convergence_support.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/country_comparison/vote_intl_coalition.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.7\textwidth]{../figures/country_comparison/gcs_comprehension.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{../figures/country_comparison/group_defended.pdf}} 
\end{figure}
...
\begin{figure}[h!]
    ...
    \makebox[\textwidth][c]{\includegraphics[width=.8\textwidth]{../figures/country_comparison/survey_biased.pdf}} 
\end{figure}
