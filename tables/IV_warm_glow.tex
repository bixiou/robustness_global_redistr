...
% Date and time: jeu., nov. 13, 2025 - 18:10:45
\begin{tabular}{@{\extracolsep{5pt}}lccccc} 
\\[-1.8ex]\hline 
\hline \\[-1.8ex] 
\\[-1.8ex] & \multicolumn{2}{c}{\makecell{Believes global\\redistr. likely}} & \multicolumn{3}{c}{Share of plausible global policies supported} \\ 
 & IV 1st Stage & IV 1st Stage & IV 2nd Stage & OLS & Direct Effect \\ 
\\[-1.8ex] & (1) & (2) & (3) & (4) & (5)\\ 
\hline \\[-1.8ex] 
 Information treatment & 0.077$^{***}$ & 0.074$^{***}$ &  &  & 0.013$^{**}$ \\ 
  & (0.010) & (0.009) &  &  & (0.007) \\ 
  Believes global redistr. likely &  &  & 0.181$^{**}$ & 0.145$^{***}$ &  \\ 
  &  &  & (0.086) & (0.007) &  \\ 
