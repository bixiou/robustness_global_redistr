...
\only<+>{\includegraphics[height=.95\textheight]{../figures/questionnaire/conjoint_US_8.png}} % TODO: add line on right
\only<+>{}
...
\begin{frame}{International Climate Scheme} % TODO: add names of ICSs
