...
\begin{subfigure}{.48\textwidth}
  \caption[]{\blue{Cut development aid}: $-$3 pp*** \quad \green{\checkmark H1a}}\vspace{-.3cm}
  \includegraphics[width=.97\textwidth]{../figures/country_comparison/program_preferred_by_cut_aid_in_program.pdf}
\end{subfigure} \pause
\begin{subfigure}{.50\textwidth}
  ...
  \includegraphics[width=.92\textwidth]{../figures/country_comparison/program_preferred_by_millionaire_tax_in_program.pdf}
\end{subfigure}
\end{figure}
\end{frame}
...
\begin{subfigure}{.47\textwidth} 
  % \caption[]
  {Effect of \blue{information about ongoing global redistribution} initiatives on the share of plausible \rose{global policies} supported: +1p.p.* \quad \hyperlink{2SLS}{\beamergotobutton{2SLS}}}
...
\begin{frame}{No evidence of warm glow} 
  ...
  \vspace{-.3cm}
    \begin{figure}
\caption{If \textit{warm glow}, support might dissipate when the policy is replaced a substitute with the same moral appeal}\vspace{-.4cm}
\begin{subfigure}{.5\textwidth} 
  % \caption[]
  {\normalsize \quad \quad \quad \blue{Moral substitute}}
...
\begin{subfigure}{.47\textwidth} 
  % \caption[]
  {\small \quad \\ Effect of a \blue{\textit{Donation lottery} treatment} on support for the \rose{Global Climate Scheme}: +3p.p.*** \quad \green{\checkmark H5a}}
  \includegraphics[width=.97\textwidth]{../figures/country_comparison/gcs_support_by_variant_warm_glow.pdf}
  \\ \quad 
\end{subfigure}
\end{figure}
\end{frame}
...
%   \includegraphics[width=.97\textwidth]{../figures/country_comparison/share_solidarity_supported_by_info_solidarity.pdf}
% \end{subfigure}
% \end{figure}
% \end{frame}
