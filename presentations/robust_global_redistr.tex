...
\ip \blue{Carattini et al. (Nature, 2019)}: $\sim$50\% support for a global tax and dividend in 3 HICs.
...
\bbvsp \ip \rose{Consensus for a global tax on millionaires, majorities support allocating 30\% of revenue to LICs}.
...
\ip \rose{A political program is $\sim$10\% more likely to be preferred if it contains the GCS or a global millionaire tax}.
\ee \ee
\end{frame}
...
\begin{frame}{International Climate Scheme}
\makebox[\textwidth][c]{ \includegraphics[width=\textwidth]{../figures/country_comparison/variables_ncs_gcs_ics_control_by_country}} % ncs_gcs_ics_all_mean
\bbvsp
...
\begin{frame}{Custom redistribution \href{run:survey_custom_redistr.mp4}{\beamergotobutton{Video}} \href{https://bit.ly/custom_redistr}{\beamergotobutton{bit.ly/custom\_redistr}}} 
    ...
    \only<6>{\begin{figure}\caption{Average custom redistribution} 
      ...
      \end{subfigure}\begin{subfigure}{.8\textwidth}
        \includegraphics[height=.8\textheight]{../figures/mean_custom_redistr/all_satisfied_touched.png}
      \end{subfigure}
    \end{figure}}
    \only<2->{
...
\begin{frame}{Representativeness (EU countries) \hyperlink{data}{\beamergotobutton{Go back}} \label{representativeness}}
    ...
    \begin{table}[h]
        \makebox[\textwidth][c]{
            ...
            \input{../tables/FR_DE_IT_PL_ES.tex}
            }
        }
    \end{table}  
\end{frame}
...
\includegraphics[height=.97\textheight]{../figures/country_comparison/vote_non_EU_pnr_out.pdf}
\end{frame}

\begin{frame}{Representativeness of vote (EU countries)  \hyperlink{data}{\beamergotobutton{Go back}}}
\includegraphics[height=.97\textheight]{../figures/country_comparison/vote_EU_pnr_out.pdf}
\end{frame}
% TODO add likelihood_global_redistr
% TODO share who oppose GCS but sign petition.
